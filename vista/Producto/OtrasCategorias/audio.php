...
$productosSoundbars = $productoControl->getProducto()->buscar('"Veracruz".producto', [
    "where" => "stock > 0 AND estatus='true' AND categoria='soundbars'", 
    "order" => "nombre ASC"
]);
?>
...
$productosBocinas = $productoControl->getProducto()->buscar('"Veracruz".producto', [
    "where" => "stock > 0 AND estatus='true' AND categoria='bocinas'", 
    "order" => "nombre ASC"
]);
?>
...
$productosAudifonos = $productoControl->getProducto()->buscar('"Veracruz".producto', [
    "where" => " stock > 0 AND estatus='true' AND categoria='audifonos'", 
    "order" => "nombre ASC"
]);
?>
...
$sistemasSonido = $productoControl->getProducto()->buscar('"Veracruz".producto', [
    "where" => "stock > 0 AND estatus='true' AND categoria='sistemassonido'", 
    "order" => "nombre ASC"
]);
?>
