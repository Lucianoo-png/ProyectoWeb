        ...
        <div class="container">
            <div class="mb-4">
                <h2 class="mb-1" style="color:var(--dark-blue); font-weight:700">
                    <i class="fas fa-utensils me-2" style="color:var(--btn-color)"></i>Lavavajillas
                </h2>
                <p class="text-muted small">Lavavajillas empotrados de 18" y 24". Silenciosos y de alta eficiencia.</p>
                <hr>
            </div>
                ...
                <div class="col-6 col-md-3">
                    <a href="#todas" class="text-decoration-none">
                        <div class="text-center p-3 border rounded bg-white shadow-sm h-100">
                            <i class="fas fa-utensils fa-2x mb-2" style="color:var(--btn-color)"></i>
