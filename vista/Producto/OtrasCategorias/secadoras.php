...
<head>
    ...
    <title>ElectroPendejo | Secadoras</title>
        ...
        <div class="container">
            <div class="mb-4">
                <h2 class="mb-1" style="color:var(--dark-blue); font-weight:700">
                    <i class="fas fa-wind me-2" style="color:var(--btn-color)"></i>Secadoras
                </h2>
                <p class="text-muted small">Secadoras eléctricas y a gas de carga frontal. Tecnología de sensor de humedad.</p>
                <hr>
            </div>
