...
<head>
    ...
    <title>ElectroPendejo | Lavasecadoras</title>
        ...
        <div class="container">
            <div class="mb-4">
                <h2 class="mb-1" style="color:var(--dark-blue); font-weight:700">
                    <i class="fas fa-sync-alt me-2" style="color:var(--btn-color)"></i>Lavasecadoras
                </h2>
                <p class="text-muted small">Equipos que lavan y secan en uno. Perfectos para espacios reducidos.</p>
                <hr>
            </div>
                ...
                <div class="col-6 col-md-3">
                    <a href="#todas" class="text-decoration-none">
                        <div class="text-center p-3 border rounded bg-white shadow-sm h-100">
                            <i class="fas fa-sync-alt fa-2x mb-2" style="color:var(--btn-color)"></i>
            ...
            <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-3 mb-5">
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-img-wrap">
                            <img src="https://placehold.co/300x250?text=WFC315S0JW" alt="Lavasecadora apilable 4.5/7.4 pies cúbicos blanca" onerror="this.src='https://placehold.co/300x250?text=WFC315S0JW'">
                        </div>
                        <div class="product-body">
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-img-wrap">
                            <img src="https://placehold.co/300x250?text=MHW8630HW" alt="Lavasecadora todo en uno 4.5 pies cúbicos acero inoxidable" onerror="this.src='https://placehold.co/300x250?text=MHW8630HW'">
                        </div>
                        <div class="product-body">
