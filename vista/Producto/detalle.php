...
<head>
    ...
    <title>ElectroPendejo | Detalle de Producto</title>
...
$productos = [
    'WM3911D' => [
        'No_Producto'=>'WM3911D','Nombre'=>'Microondas de mesa con función AirFry y 4 modos en 1',
        ...
        'Manual'=>'../../multimedia/Manuales/microondas-wm3911d.pdf','Categoria'=>'cocina',
    ],
    '8MWTW2024WJM' => [
        'No_Producto'=>'8MWTW2024WJM','Nombre'=>'Lavadora 20kg Carga Superior Xpert System Blanca Agitador',
        ...
        'Manual'=>'../../multimedia/Manuales/lavadora-8mwtw2024wjm.pdf','Categoria'=>'blanca',
    ],
    'WK0260B' => [
        'No_Producto'=>'WK0260B','Nombre'=>'Despachador de agua con fábrica de hielo',
        ...
        'Manual'=>'../../multimedia/Manuales/despachador-wk0260b.pdf','Categoria'=>'blanca',
    ],
    'WRS315SNHM' => [
        'No_Producto'=>'WRS315SNHM','Nombre'=>'Refrigerador Side by Side 25 pies con despachador de agua y hielo',
        ...
        'Manual'=>'../../multimedia/Manuales/refrigerador-wrs315snhm.pdf','Categoria'=>'blanca',
    ],
    'MGH765RDS' => [
        'No_Producto'=>'MGH765RDS','Nombre'=>'Estufa de gas 6 quemadores con horno convección acero inoxidable',
        'Descripcion'=>'Estufa de 30" color negro acero porcelanizado con seis quemadores y tres parrillas las cuales son de alambrón con encendido eléctrico contando con un sistema de seguridad push & turn contando con un horno con capacidad de 5.1 pies cúbicos y ventana de horno panorámica semi ahumada.',
        'Precio_Venta'=>9799.00,'Alto'=>92.0,'Ancho'=>76.0,
        'Imagen'=>'../../multimedia/Imagenes/productos/estufa-mgh765rds.jpg',
        'Manual'=>'../../multimedia/Manuales/estufa-mgh765rds.pdf','Categoria'=>'cocina',
    ],
    'WED5000DW' => [
        'No_Producto'=>'WED5000DW','Nombre'=>'Secadora eléctrica de carga frontal 7.0 pies cúbicos blanca',
        ...
        'Manual'=>'../../multimedia/Manuales/secadora-wed5000dw.pdf','Categoria'=>'blanca',
    ],
    'WDF520PADM' => [
        'No_Producto'=>'WDF520PADM','Nombre'=>'Lavavajillas empotrable 24" con ciclo de alta temperatura acero inox',
        ...
        'Manual'=>'../../multimedia/Manuales/lavavajillas-wdf520padm.pdf','Categoria'=>'cocina',
    ],
    'WQ09X' => [
        'No_Producto'=>'WQ09X','Nombre'=>'Frigobar 9 pies con congelador y acabado acero inoxidable',
        ...
        'Manual'=>'../../multimedia/Manuales/frigobar-wq09x.pdf','Categoria'=>'blanca',
    ],
];

$sku = isset($_GET['sku']) ? strtoupper(trim($_GET['sku'])) : 'WM3911D';
$p   = isset($productos[$sku]) ? $productos[$sku] : $productos['WM3911D'];
        ...
        <div class="container">
            <nav aria-label="breadcrumb"><ol class="breadcrumb mb-0 small">
                ...
                <li class="breadcrumb-item">
                    <a href="<?= htmlspecialchars($cat_file) ?>" class="text-decoration-none" style="color:var(--btn-color)"><?= htmlspecialchars($cat_label) ?></a>
                </li>
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-4">
                    ...
                    <p class="detail-sku text-muted small">Código de producto (SKU): <?= htmlspecialchars($p['No_Producto']) ?></p>
                    <hr class="my-3">
                    ...
                    <p class="detail-disponible"><i class="fas fa-check-circle me-1" style="color:#28a745"></i> Disponible</p>
                    <hr class="my-3">
                ...
                <div class="col-lg-3">
                    <div class="detail-buy-box">
                        ...
                        <p class="text-muted small mb-3">IVA incluido</p>
                        <hr class="my-3">
            ...
            <div class="row g-4 mt-1 mb-5">
                <div class="col-lg-7">
                    ...
                    <p class="text-muted" style="font-size:.9rem; line-height:1.8"><?= nl2br(htmlspecialchars($p['Descripcion'])) ?></p>
                ...
                <div class="col-lg-5">
                    ...
                    <table class="table table-sm detail-specs-table">
                        <tbody>
                            <tr><td class="spec-key">No. Producto</td><td class="spec-val"><?= htmlspecialchars($p['No_Producto']) ?></td></tr>
                            <tr><td class="spec-key">Medidas (Alto x Ancho)</td><td class="spec-val"><?= number_format($p['Alto'],1) ?> x <?= number_format($p['Ancho'],1) ?> cm</td></tr>
                            <tr><td class="spec-key">Categoría</td><td class="spec-val"><?= htmlspecialchars($cat_label) ?></td></tr>
                            <?php if (!empty($p['Manual'])): ?>
                            <tr><td class="spec-key">Manual</td><td class="spec-val">
                                <a href="<?= htmlspecialchars($p['Manual']) ?>" target="_blank" style="color:var(--btn-color); text-decoration:none">
