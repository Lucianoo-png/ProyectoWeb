...
<head>
    ...
    <title>ElectroPendejo | Admin — Reporte de Ventas</title>
...
<body>
    <div class="topbar">
        <div class="container-fluid d-flex justify-content-between px-3">
            <div>
                ...
                <span class="d-none d-md-inline"><i class="fas fa-envelope me-1"></i> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="92e1fde2fde0e6f7d2f7fef7f1e6e0fde2f7fcf6f7f8fdbcf1fdff">[email&#160;protected]</a></span>
            </div>
    ...
    <div class="admin-layout">
        <nav class="admin-sidebar">
            ...
            <a href="admin_reportes_ventas.php" class="nav-link active"><i class="fas fa-chart-bar"></i> Ventas</a>
        ...
        <main class="admin-content">
            ...
            <div class="report-form-card">
                <h5><i class="fas fa-chart-bar me-2" style="color:var(--btn-color)"></i>Generar Reporte de Ventas</h5>
                <form action="admin_reportes_ventas.php" method="GET" novalidate>
                    <div class="row g-3">
                        <div class="col-md-6">
